  ...
  return (
    <Container>
      ...
      <Main>
        ...
        <p>
          Abaixo estão os profissionais que você favoritou, você pode ir diretamente para a página deles para agendar uma consulta ou pode excluí-los dos favoritos!
        </p>
        <div className="main">
